...
export interface IAssetBaseThunk {
...
export interface IAssetAsyncThunk{
...
export interface IGetAssetDetailsAsyncThunk extends IBaseBondAsyncThunk {
  readonly value: string;
}
...
export interface IDividEndsAsyncThunk extends IBaseAsyncThunk {
  readonly address: string;
  dispatch: any;
}
