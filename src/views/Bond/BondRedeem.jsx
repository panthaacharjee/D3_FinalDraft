      ...
      <Box display="flex" justifyContent="space-around" flexWrap="wrap">
        {!address ? (
          ...
          <>
            ...
            >
              {txnButtonText(pendingTransactions, "redeem_bond_" + bond.name + "_autostake", t`Claim and Auto-Stake`)}
            </Button>
          </>
        )}
      </Box>
        ...
        <Box className="bond-data">
          <div className="data-row">
            ...
            <Typography className="price-data">
              {isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.interestDue, 4)} DEFI`}
            </Typography>
          </div>
          <div className="data-row">
            <Typography>
            ...
            <Typography id="claimable" className="price-data">
              {isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.pendingPayout, 4)} DEFI`}
            </Typography>
          </div>
          <div className="data-row">
            <Typography>
